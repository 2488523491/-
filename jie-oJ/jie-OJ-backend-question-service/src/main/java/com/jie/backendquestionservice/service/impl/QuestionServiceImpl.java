...
import com.jie.backendModel.model.dto.question.QuestionQueryRequest;
...
import com.jie.backendquestionservice.mapper.QuestionMapper;
 ...
 * @createDate 2024-03-21 11:23:39
 */
@Service
public class QuestionServiceImpl extends ServiceImpl<QuestionMapper, Question>
    ...
    /**
     * 获取查询包装类 （用户可能根据哪些字段查询，根据前端传来的请求对象，得到mybits 框架支持的查询 QueryWrapper 类）
     *
    ...
    public Page<QuestionVO> getQuestionVOPage(Page<Question> questionPage, HttpServletRequest request) {
        ...
        List<QuestionVO> questionVOList = questionList.stream().map(question -> {
            ...
            questionVO.setUseVO(userFeignClient.getUserVO(user));
            return questionVO;
